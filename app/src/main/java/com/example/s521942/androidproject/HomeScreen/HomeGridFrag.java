...
public class HomeGridFrag extends Fragment {
    public static String [] prgmNameL={"Events","Need a Pickup?","Accomodation & facilities","Store locations","Conatct info","Bridge"};
    public static int [] prgmImage={R.drawable.events,R.drawable.pickup,R.drawable.home,R.drawable.store,R.drawable.contact,R.drawable.bridgenew};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        typeface= Typeface.createFromAsset(view.getContext().getAssets(), "fonts/orange.ttf");
